...
router.get("/get-product-detail/:id", validate(slugOrIdParams(), "params"), optionalProtectRoute, trackBehavior("view", "Product"), getProductDetail)
router.get("/search", validate(paginationQuery, "query"), optionalProtectRoute, trackBehavior("search", "Product"), searchProducts)
router.get("/get-by-category", validate(paginationQuery, "query"), optionalProtectRoute, trackBehavior("view_category", "Product"), getProductsByCategory)
router.get("/get-by-region", validate(paginationQuery, "query"), optionalProtectRoute, trackBehavior("view_region", "Product"), getProductsByRegion)

router.get("/get-popular", validate(paginationQuery, "query"), optionalProtectRoute, getPopularProducts)
router.get("/get-shock-deals", validate(paginationQuery, "query"), optionalProtectRoute, getShockDeals)
router.get("/get-suggestion", validate(paginationQuery, "query"), optionalProtectRoute, getSuggestedProducts)
