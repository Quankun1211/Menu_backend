...
router.post("/", protectRoute, authorizeRole(["admin", "super_admin"]), upload.single("images"), validate(categorySchema), createCategories)
router.get("/", validate(paginationQuery, "query"), getCategories)
